    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p className="text-base text-gray-700 md:text-lg">
          Bargain Bay: Navigate Extraordinary Savings and Seamless Reselling
          Experiences with Our Feature-Rich Platform for Savvy Shoppers and
          Resellers!
        </p>
      </div>
      <div className="grid gap-10 row-gap-10 lg:grid-cols-3">
        <div className="max-w-md sm:mx-auto sm:text-center">
          <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-yellow-200 sm:mx-auto sm:w-24 sm:h-24">
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                <path d="m19.828 6.612-5.52-5.535a3.135 3.135 0 0 0-4.5 0L4.273 6.612l7.755 3.87zm2.118 2.235 1.095 1.095a3.12 3.12 0 0 1 0 4.5L14.22 23.35a2.685 2.685 0 0 1-.72.525V13.077zm-19.893 0L.958 9.942a3.12 3.12 0 0 0 0 4.5L9.78 23.35c.21.214.453.392.72.525V13.077z"></path>
              </g>
            </svg>
          </div>
          ...
          <p className="mb-3 text-sm text-gray-900">
            Rely on Bargain Bay's cutting-edge blockchain-powered payment system
            for every transaction, providing unmatched security and
            transparency, fostering trust in every step of your shopping
            journey.
          </p>
        </div>
        <div className="max-w-md sm:mx-auto sm:text-center">
          ...
          <p className="mb-3 text-sm text-gray-900">
            Experience the ease and confidence of smart shopping on our
            platform, where you can effortlessly compare products, make informed
            choices, and always save on the best deals.
          </p>
        </div>
        <div className="max-w-md sm:mx-auto sm:text-center">
          <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-yellow-200 sm:mx-auto sm:w-24 sm:h-24">
          ...
          <p className="mb-3 text-sm text-gray-900">
            Enhance the security of your Bargain Bay account by implementing a
            2-Factor Authentication system, ensuring strong protection for a
            trustworthy and hassle-free experience.
          </p>
        </div>
        <div className="max-w-md sm:mx-auto sm:text-center">
          <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-yellow-200 sm:mx-auto sm:w-24 sm:h-24">
          ...
          <p className="mb-3 text-sm text-gray-900">
            Elevate Conversations - Seamless 2Chatbor Experience, Powered by
            OpenAI and ChatGPT Integration, for Intelligent and Engaging
            Interactions on Bargain Bay.
          </p>
        </div>

        <div className="max-w-md sm:mx-auto sm:text-center">
          <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-yellow-200 sm:mx-auto sm:w-24 sm:h-24">
            <svg className="w-12 h-12" fill="#000000" viewBox="0 0 24 24">
              <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
              <g
                id="SVGRepo_tracerCarrier"
                strokeLinecap="round"
          ...
          <p className="mb-3 text-sm text-gray-900">
            Simplify Transactions - Instant and Accurate Invoice Generation,
            Empowering Seamless Financial Management for Your Transactions on
            Bargain Bay.
          </p>
        </div>
        ...
        <div className="max-w-md sm:mx-auto sm:text-center">
          <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-yellow-200 sm:mx-auto sm:w-24 sm:h-24">
            <svg className="h-12 w-12" fill="#000000" viewBox="0 0 24 24">
              <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
              <g
                id="SVGRepo_tracerCarrier"
                strokeLinecap="round"
          ...
          <p className="mb-3 text-sm text-gray-900">
            Elevate Engagement - Seamless Video and Chat Integration, Fostering
            Real-Time Connections for an Interactive and Personalized Shopping
            Experience on Bargain Bay.
          </p>
        </div>
      </div>
    </div>
